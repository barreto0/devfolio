export const pt_BR = {
  ...
  name_section: {
    ...
    fullstack_developer: 'Desenvolvedor Fullstack e Mobile',
  ...
  about_section: {
    ...
    fluent_in: 'e fluente em Inglês, sou apaixonado pelo que faço',
    with_expertise:
      'Com domínio dos espectros frontend, backend e mobile, construo qualquer sistema web e móvel a partir do nada',
  },
  skills_section: {
    player_cards: 'As cartas do jogador',
    engineering: 'Engenharia',
    engineering_description:
      'Do IoT ao projeto de peças sob medida para as mais diversas aplicações. Sempre prezo pela qualidade e eficiência dos trabalhos que desenvolvo, buscando o equilíbrio entre orçamento e qualidade.',
    expertise: 'Especialidade',
    expertise_description:
      'Soluções em automação residencial e do campo, projetos sob medida, soluções em eletrônica automotiva.',
    main_hardware_and_tools: 'Principais Hardwares e Ferramentas',
    development: 'Desenvolvimento',
    development_description:
      'Frontend, Backend ou Mobile. Seja a vertente desenvolvo com TDD o seu projeto de ponta a ponta, com a qualidade necessária para futuras manutenções e implementação de novas features.',
    development_expertise:
      'Do mais simples gerenciador de músicas de karaokê ao mais completo sistema de backoffice com uso de websockets.',
    main_development_tech: 'Principais Tecnologias',
    soft_skills_1:
      'Com comunicação e agilidade orquestro com maestria as entregas do seu projeto. Sempre mantendo clareza e transparência com o cliente, do contrato à entrega final.',
    soft_skills_2:
      'Com sede de conhecimento sempre estou em busca de novas tecnologias e tendências mais atuais do mercado.',
    soft_skills_3:
